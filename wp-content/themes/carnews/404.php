...
<meta http-equiv="content-type" content="text/php; charset=<?php bloginfo( 'charset' ); ?>" />
<meta name="description" content="CarCare  -  Car Repairing  and Servicing php Template Responsive Template">
...
<link rel="apple-touch-icon" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/images/fav-icon/apple-icon-152x152.php">
                    ...
                    <nav class="main-navigation">
                        <ul class="main-menu">
                            ...
                            <li class="has-dropdown"><a href="#">about us</a>
                                <ul>
                                    <!-- Dropdown Items -->
                                    <li><a href="about-1.php">About V1</a></li>
                                    <li><a href="about-2.php">About V2</a></li>
                                </ul>
                            </li>
                            <li class="has-dropdown"><a href="#">Gellery</a>
                                <ul>
                                    ...
                                    <li><a href="gallery-4-col.php">Gallery Four Col</a></li>
                                </ul>
                            </li>
                            <li class="has-dropdown"><a href="#">Team</a>
                                <ul>
                                    ...
                                    <li><a href="team-2-col.php">Team 2 col</a></li>
                                    <li><a href="team-3-col.php">Team 3 col</a></li>
                                    <li><a href="team-4-col.php">Team 4 col</a></li>
                            ...
                            <li class="has-dropdown"><a href="#">News</a>
                                <ul>
                                    <!-- Dropdown Items -->
                                    <li><a href="news-left-sidebar.php">Two Columns LSB</a></li>
                                    <li><a href="news-right-sidebar.php">Two Columns LSB</a></li>
                                    <li><a href="news-single-fluid.php">Blog 3col Grid</a></li>
                                    <li><a href="news-single-left-sidebar.php">Blog List LSB</a></li>
                                    <li><a href="news-single-right-sidebar.php">Blog List RSB</a></li>
                                </ul>
                            </li>
                            <li class="has-dropdown"><a href="contact-us.php">services</a>
                                <ul>
                                    <li><a href="service-1.php">Service One</a> </li>
                                    <li><a href="service-2.php">Service Two</a> </li>
                                </ul>
                            </li>
                            <li class="has-dropdown"><a href="#">Contact</a>
                                <ul>
                                    <li><a href="contact-1.php">Service One</a> </li>
                                    <li><a href="contact-2.php">Service Two</a> </li>
                                    <li><a href="contact-3.php">Service Three</a> </li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
        <div class="error404">
            ...
            <a class="btn-primary" href="index-2.php">Go Back</a>
        </div>
    </div>
</div>
</div>
