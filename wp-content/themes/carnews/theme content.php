...
Comments Count যোগ  করার জন্য 
================================ 
<?php comments_popup_link( 'No Comment', '1 Comment >>', '% Comments');?>


Post or article show করার জন্য
================================  
...
Bootstrap menus Register করার জন্য
================================  
<?php
wp_nav_menu(
    array(
...
function carnews_reigister_menu()
{
    if(function_exists('register_nav_menu')){
        ...
        register_nav_menu( 'header_top_sub_menu', __('Main Menu Sub Menu','carnews') );
